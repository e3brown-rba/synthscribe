...
class CacheConfig:
    ...
    max_size: int = 1000
    cache_dir: Path = field(default_factory=lambda: Path.home() / ".synthscribe" / "cache")
...
class AnalyticsConfig:
    ...
    analytics_dir: Path = field(default_factory=lambda: Path.home() / ".synthscribe" / "analytics")
...
class FeatureFlags:
    ...
    ab_tests: Dict[str, Dict[str, Any]] = field(default_factory=lambda: {
        "prompt_style": {
            "enabled": True,
