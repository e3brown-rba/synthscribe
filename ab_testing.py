...
class Experiment:
    ...
    def is_significant(self) -> Tuple[bool, Optional[str], float]:
        ...
        if (v1.metrics["impressions"] < self.min_sample_size or 
            v2.metrics["impressions"] < self.min_sample_size):
            return False, None, 1.0
        ...
        # Pooled probability
        p_pooled = ((v1.metrics["successes"] + v2.metrics["successes"]) / 
                   (n1 + n2))
...
class ABTestingManager:
    ...
    def create_experiment(self, name: str, description: str, 
                         variants: List[Dict[str, Any]]) -> Experiment:
    ...
    def record_feedback(self, experiment_name: str, variant_name: str, 
                       score: float):
...
if __name__ == "__main__":
    ...
    for user_id in users:
        ...
        if random.random() > 0.4:  # 60% success rate
            ...
            ab_manager.record_feedback("prompt_optimization_v1", variant, feedback_score)
